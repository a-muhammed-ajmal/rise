...
- **Brand**: `--brand: #FF6535` (accents, borders, icon fills, focus — NOT filled-surface text), `--brand-action: #C2410C` (filled button/FAB surfaces with white text — raw `--brand` is only 2.93:1 and fails AA there), `--brand-hover: #FF8159`, `--brand-text: #CC4400` (orange text on white, AA 4.8:1), `--brand-tint: #FFF0EB` (chips/badges).
