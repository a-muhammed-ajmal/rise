...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center px-6 bg-[#0A0A0F]">
      <div className="w-full max-w-sm space-y-8">
        ...
        <button onClick={signInWithGoogle}
          className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#13131C] border border-[#ffffff0f] rounded-2xl hover:border-[#ffffff1a] hover:bg-[#1A1A24] transition-all duration-150 text-text font-semibold">
